...
import com.trading.app.Repositary.CoinRepositary;
...
public class CoinServiceImpl implements CoinService{
	...
	@Override
	public Coin findById(String coniId) throws Exception {
		Optional<Coin> optionalCoin =coinRepositary.findById(coniId);
